<html>
<head>
<title> HINDI SONGS CONTENT</title>
...
<div class="row" style="margin-top:30px;">
	<div class="col-md-12">
		<h2 style="text-align:center; font-size:40px; font-weight:bold; font-family:'Courier New', Courier, monospace; color:#CA0065;">
			<u>DESCRIPTION ABOUT SONGS</u>
		</h2>
				...
				<div class="row">
					<div class="col-md-12" style="margin-top:60px;">
						<div class="col-md-1"></div><!--=====col-md-2 close=============--->
							<div class="col-md-10">
								<h2 style="text-align:center; font-size:50px; font-weight:bold; font-family:'Courier New', Courier, 		monospace; color:#CA0065;"><u>HINDI SONGS LIST</u>
...
<input type="search" name="search" id="u2" placeholder="Type keyword" style="margin-left:10px; opacity:0.7; color:#000000;">Search Song</p>
		...
		$i=0;
		$sql="select * from songs where category='hindi'";
		...
		include'includes/db.php';
		$i=0;
		$sql="select * from songs where category='hindi' limit 5";
		$run=mysqli_query($conn,$sql);
		while($c=mysqli_fetch_array($run)){
		$i++;?>
		<tbody style="font-size:25px; font-weight:bold; font-family:'Times New Roman', Times, serif; text-align:center; color:#ca0065;">
		...
		<br>
				...
				<div class="col-md-1"></div><!--======col-md-1 cxlose=================------->
