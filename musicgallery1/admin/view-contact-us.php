...
<div class="container-fluid" >
	...
	<div class="row" >
				...
				<table border="1" class="table-responsive" align="center" width="95%" cellpadding="20" cellspacing="10" style="margin-top:30px;">
				...
				<th style="text-align:center;">ENQUIRY EMAIL</th>
				...
				<td><?php echo $i?></td>
				<td><?php echo $c['moble_phone'];?></td>
				<td><?php echo $c['office_phone'];?></td>
				<td><?php echo $c['email'];?></td>
				<td><?php echo $c['enquiry_mail'];?></td>
				<td><a href="delete-action-contact_us.php?uid=<?php echo $c['uid'];?>" class="btn btn-sm btn-danger">DELETE</a></td>
				</tr>
				</tbody>
				<?php }?>
				</table>
