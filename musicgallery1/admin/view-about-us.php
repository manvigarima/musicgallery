...
<title>view about us information of musicality</title>
...
<div class="container-fluid" >
	...
	<div class="row" >
				...
				<table border="1" class="table-responsive" align="center" width="100%" cellpadding="20" cellspacing="10" style="margin-top:30px;">
				...
				$i++;?>
				<tbody style="font-size:18px; text-align:justify; font-weight:bold; text-align:center;">
				<tr style="height:40px;">
				<td><?php echo $i?></td>
				<td><?php echo $c['short'];?></td>
				<td><?php echo $c['full'];?></td>
				<td><img src="images/<?php echo $c['image'];?>" style="width:100%; height:100px;"></td>
				<td><a href="delete-action-about_us.php?uid=<?php echo $c['uid'];?>" class="btn btn-sm btn-danger">DELETE</a></td>
				</tr>
				</tbody>
				<?php }?>
				</table>
