...
<title>contact us info of musicality</title>
...
<div class="container-fluid" >
	...
	<div class="row" >
				...
				<h2 style="text-align:center; font-size:30px; font-family:'Courier New', Courier, monospace; font-weight:bold; margin-top:30px;">INSERT CONTACT INFORMATION</h2>
				...
				<form name="f4" method="post" action="action-insert-contact-us-detail.php">
				...
				<tr style="height:50px;">
				<td>ENTER ENQUIRY EMAIL:-</td>
				<td><input type="email" name="eemail" required></td>
				</tr>
				
				
				<tr style="height:50px;">
				<td>ENTER OFFICE No:-</td>
				<td><input type="number" name="onum" required></td>
				</tr>
