...
<div class="row" style="margin-top:50px;">
	...
	<div class="col-md-12">
		...
		<div class="col-md-10">
		<h2 style="text-align:center; font-size:50px; font-weight:bold; font-family:'Courier New', Courier, monospace; color:#CA0065;"><u>HOLLYWOOD SONGS LIST</u>
...
<input type="search" name="search" id="u2" placeholder="Type keyword" style="margin-left:10px; opacity:0.7; color:#000000;">Search Song</p>
		...
		$i=0;
		$sql="select * from songs where category='english'";
